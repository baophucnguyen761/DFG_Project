...
public class Diagram extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button StartMenu=new Button("Back ");
        Button enter= new Button("enter");

        proceedButton.setOnAction(e ->
                {
                    proceed();
                    Scene scene1 = new Scene(grid2, 530, 210);
                    grid2.add(viewOutputComboBox,0,0);
                    grid2.add(enter,1,0);
                    grid2.add(StartMenu,0,1);
                    primaryStage.setScene(scene1);
                    primaryStage.show();
                }
        );
        enter.setOnAction(e->proceed());
        ...
        //add 11/24/24
        grid.add(CodeWord,0,4);
        grid.add(inputCodeString,1,4);
    ...
    private void proceed() {
        ...
        if(codeType.equals("Old Project")){
            if (filePath.isEmpty()) {
                fileService.showAlert("Error", "Please select a old Project.");
